...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference("Solution.count") do
      post solutions_url, params: { solution: { content: @solution.content, task_id: @solution.task_id, user_id: @solution.user_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { content: @solution.content, task_id: @solution.task_id, user_id: @solution.user_id } }
